...
## Sample data installed on your instant sandbox

Sample data packs are pre-installed on your instant sandbox. Your sandbox includes the following sample data:
...
- **Mail & events** - Outlook email conversations and calendar events for each of the 16 sample users. Use Microsoft Graph APIs to work with mail and events sample data in the following ways:
  - Get emails by users
